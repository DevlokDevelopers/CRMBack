...
ALLOWED_HOSTS = ["testcrm.up.railway.app","crmbackend.up.railway.app","localhost","127.0.0.1",]  # Set specific Railway domain in production for security
